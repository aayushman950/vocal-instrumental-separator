...
# Your old librosa-based method, renamed
def extract_vocals_instrumentals_librosa(file_path):
    ...
    os.makedirs(output_dir, exist_ok=True)
    base_filename = os.path.splitext(os.path.basename(file_path))[0]
    vocal_path = os.path.join(output_dir, f"{base_filename}_vocals_librosa.wav")
    instr_path = os.path.join(output_dir, f"{base_filename}_instrumentals_librosa.wav")
